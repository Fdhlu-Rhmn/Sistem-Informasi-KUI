        ...
        <div class="d-fle sticky-top flex-column justify-content-between col-auto bg-white min vh-100 ">
            <div>
                <ul class="nav nav-pills d-flex flex-column ms-3 mt-3">
                    ...
                    <li class="nav-item disabled mb-4">
                        <a href="/artikel" class="nav-link-active text-black text-decoration-none fw-bold f6-3 p-2"
                            aria-current="page">
                    ...
                    <li class="nav-item disabled mb-4">
                        <a href="/profil" class="nav-link-active text-black text-decoration-none fw-bold fs-6 p-2"
                            aria-current="page">
                    ...
                    <li class="logout">
                        <a href="/" data-bs-toggle="collapse"
                            class="nav-link-active text-black text-decoration-none fw-bold fs-6" aria-current="page">

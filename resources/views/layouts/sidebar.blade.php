                ...
                <ul class="nav nav-pills d-flex flex-column ms-3 mt-3">
                    ...
                    <li class="nav-item disabled mb-4">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                            <li class="w-100 py-3" >
                                <a href="#" class="align-middle nav-link-active text-black text-decoration-none fs-6  p-2 pb-4"> 
                                    <i class="fa-solid fa-caret-right"></i>
                                    <span class="d-none d-sm-inline px-2">Inbound</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="align-middle nav-link-active text-black text-decoration-none   p-2 pb-4 fs-6 ">
                                    <i class="fa-solid fa-caret-right"></i>
